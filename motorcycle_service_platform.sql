...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '预约信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of appointment
-- ----------------------------
INSERT INTO `appointment` VALUES (2, 'APT176179763198587D371', 3, 2, 6, '2025-10-30 00:00:00', 2, 1, NULL, '13007688765', '达娃大青蛙大全hi的话iu氰化物i哦请问河东区我会哦环球', '', 3, '2025-10-30 12:13:52', '2025-10-30 12:27:20');
INSERT INTO `appointment` VALUES (3, 'APT176179770428828F918', 3, 2, 7, '2025-10-31 10:01:00', 2, 1, NULL, '13690897765', '去都i回去我都很强悍的i强无敌hi去武汉丢回去i去武汉地区我核对哦请问的环境佛齐我', '', 0, '2025-10-30 12:15:04', '2025-10-30 12:15:04');
INSERT INTO `appointment` VALUES (4, 'APT176179857741663F26D', 3, 1, 8, '2025-10-30 00:00:00', 2, 1, NULL, '13876546757', '啊我的空间内外交困的内裤不打卡我几乎不能抵扣外裤对比哦我和你农行你的欧文i去', '', 0, '2025-10-30 12:29:37', '2025-10-30 12:29:37');
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '预约评价表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of appointment_review
-- ----------------------------
INSERT INTO `appointment_review` VALUES (1, 2, 3, 2, 5, 5, 5, 5, '哈哈哈', '', NULL, NULL, 1, 0, '2025-10-30 15:13:44', '2025-10-30 15:13:44');
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '预约服务项目关联表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of appointment_service_item
-- ----------------------------
INSERT INTO `appointment_service_item` VALUES (2, 2, 2, NULL, 1, '2025-10-30 12:13:52');
INSERT INTO `appointment_service_item` VALUES (3, 3, 1, NULL, 1, '2025-10-30 12:15:04');
INSERT INTO `appointment_service_item` VALUES (4, 4, 4, NULL, 1, '2025-10-30 12:29:37');
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '摩托车信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of motorcycle
-- ----------------------------
INSERT INTO `motorcycle` VALUES (6, 4, '云L12345', '雅马哈', '雅马哈', NULL, NULL, NULL, 1, '2025-10-30 12:13:52', '2025-10-30 12:13:52');
INSERT INTO `motorcycle` VALUES (7, 4, '云L23456', '哈雷', '哈雷', NULL, NULL, NULL, 1, '2025-10-30 12:15:04', '2025-10-30 12:15:04');
INSERT INTO `motorcycle` VALUES (8, 4, '云A12345', '雅马哈', '雅马哈', NULL, NULL, NULL, 1, '2025-10-30 12:29:37', '2025-10-30 12:29:37');
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '车主信息表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of owner_info
-- ----------------------------
INSERT INTO `owner_info` VALUES (4, 3, NULL, NULL, NULL, NULL, '2025-10-30 12:13:52', '2025-10-30 12:13:52');
