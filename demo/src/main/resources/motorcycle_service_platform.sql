...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商家信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商家工位表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '摩托车信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '车主信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '预约占用表（解决并发冲突）' ROW_FORMAT = Dynamic;
...
CREATE TABLE `service_evaluation`  (
  ...
  CONSTRAINT `fk_evaluation_merchant` FOREIGN KEY (`merchant_id`) REFERENCES `merchant` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `fk_evaluation_order` FOREIGN KEY (`order_id`) REFERENCES `order_main` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
  CONSTRAINT `fk_evaluation_owner` FOREIGN KEY (`owner_id`) REFERENCES `owner_info` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
...
CREATE TABLE `sys_user` (
  ...
  `role` varchar(20) NOT NULL COMMENT '角色：user（普通用户）、shop（商家）、admin（管理员）',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态：0-禁用，1-启用',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
-- 添加一些测试数据
INSERT INTO `sys_user` VALUES (1, 'shop_admin', '$2a$10$eDk5h2hXjM6I7Z8cV9bN7O4r5t6y7u8i9o0p1q2w3e4r5t6y7u8i', '13900139000', 'shop@example.com', '商家管理员', NULL, 'shop', 1, NOW(), NOW());
INSERT INTO `sys_user` VALUES (2, 'test_user', '$2a$10$eDk5h2hXjM6I7Z8cV9bN7O4r5t6y7u8i9o0p1q2w3e4r5t6y7u8i', '13800138000', 'user@example.com', '测试用户', NULL, 'user', 1, NOW(), NOW());
INSERT INTO `sys_user` VALUES (3, 'admin', '$2a$10$eDk5h2hXjM6I7Z8cV9bN7O4r5t6y7u8i9o0p1q2w3e4r5t6y7u8i', '13700137000', 'admin@example.com', '系统管理员', NULL, 'admin', 1, NOW(), NOW());

-- 添加车主信息
INSERT INTO `owner_info` VALUES (1, 2, NULL, '云南省昆明市五华区翠湖路', 25.0404, 102.7115, NOW(), NOW());
